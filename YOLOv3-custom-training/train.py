...
def _main():
    annotation_path = 'D:\Python\yolo_prom02\\yolo_keras\YOLOv3-custom-training\custom_train.txt'
    log_dir = 'D:\Python\yolo_prom02\\yolo_keras\YOLOv3-custom-training\\logs\\003\\'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes, freeze_body=2, weights_path='D:\Python\\yolo_prom02\\yolo_keras\YOLOv3-custom-training\model_data\yolo_weights.h5') # make sure you know what you freeze
    logging = TensorBoard(log_dir=log_dir)
    checkpoint = ModelCheckpoint(log_dir + 'ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5',
        monitor='val_loss', save_weights_only=True, save_best_only=True,save_freq='epoch', period=3)
